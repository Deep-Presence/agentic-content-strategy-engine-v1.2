...
|-----------|-------|--------|----------|----------|
| Crawlability | 96 | 20% | 19.3 | 2 |
| Performance | 98 | 10% | 9.8 | 1 |
| On Page Seo | 92 | 15% | 13.8 | 5 |
| Extractability | 96 | 20% | 19.1 | 3 |
| Schema Markup | 97 | 10% | 9.7 | 4 |
| Eeat | 100 | 15% | 15.0 | 0 |
...
### 4. [HIGH] Page may be client-side rendered — only 6 visible words detected. AI crawlers cannot extract content from CSR pages.

- **Dimension:** Performance
- **Affected pages:** 1
- **Recommendation:** Ensure the page is server-side rendered (SSR) or uses static site generation (SSG). AI bots typically do not execute JavaScript, so CSR pages appear blank to them. Implement SSR or pre-rendering to make content accessible.

### 5. [HIGH] AEO snippet readiness score is 0/100 — poor. This page is unlikely to be cited in AI search results.
...
### 6. [MEDIUM] Meta description is too long (210 chars; maximum: 160).

- **Dimension:** On Page Seo
- **Affected pages:** 1
- **Recommendation:** Shorten the meta description to 160 characters or fewer to avoid truncation.

### 7. [MEDIUM] Page has no internal links.
...
### 8. [MEDIUM] Homepage is missing Organization schema markup. AI engines use Organization schema to establish entity identity.
...
### 9. [MEDIUM] Schema validation error: Article/BlogPosting missing recommended field: image

- **Dimension:** Schema Markup
- **Affected pages:** 1
- **Recommendation:** Fix the schema markup error to ensure AI engines can parse and trust the structured data on this page.

### 10. [MEDIUM] Only 29% of headings are phrased as questions (threshold: 30%). Question-format headings improve AI snippet extraction.
