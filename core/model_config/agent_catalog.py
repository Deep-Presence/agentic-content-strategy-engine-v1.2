...
def all_agent_definitions() -> list[AgentDefinition]:
    ...
    definitions = [
        ...
        _agent("content.worker.outliner", "Outliner", "Content Engine", "content", "worker_outliner", s.content_engine_v13_worker_model, capabilities=(chat, structured)),
        _agent("content.worker.drafter", "Drafter", "Content Engine", "content", "worker_drafter", s.content_engine_v13_worker_model, capabilities=(chat,)),
        _agent("content.worker.reviser", "Reviser", "Content Engine", "content", "worker_reviser", s.content_engine_v13_worker_model, capabilities=(chat,)),
        _agent("content.worker.fact_enricher", "Fact Enricher", "Content Engine", "content", "worker_fact_enricher", s.content_engine_v13_fact_enricher_model, capabilities=(chat, web_citations)),
        ...
        _agent("content.formatter", "Formatter", "Content Engine", "content", "formatter", s.content_engine_v13_formatter_model, capabilities=(chat,)),
        _agent("content.judge.style", "Style Judge", "Content Engine", "content", "judge_style", s.content_engine_v13_style_judge_model, capabilities=(chat, structured)),
        _agent("content.judge.factual", "Factual Judge", "Content Engine", "content", "judge_factual", s.content_engine_v13_factual_judge_model, capabilities=(chat, structured)),
