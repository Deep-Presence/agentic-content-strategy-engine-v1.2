...
def build_author_research_user_prompt(
    ...
    parts.append("")
    parts.append("Cover all 10 deliverables from the system prompt:")
    parts.append("1. Executive TL;DR")
    parts.append("2. Background Snapshot")
    parts.append("3. Style Markers Table")
    parts.append("4. Motivations & Worldview")
    parts.append("5. Evidence Library")
    parts.append("6. Structure & Hook Patterns")
    parts.append("7. Lexicon Map")
    parts.append("8. Analogy Rules")
    parts.append("9. Audience Handling")
    parts.append("10. Quant Kit")
    parts.append("")
    parts.append(
