...
def get_gap_summary(
    ...
    return get_summary(artifacts_root, slug)
...
def get_gap_clusters(
    ...
    return get_clusters(artifacts_root, slug)
...
def get_gap_signals(
    ...
    return get_signals(artifacts_root, slug)
...
def get_gap_platforms(
    ...
    return get_platforms(artifacts_root, slug)
...
def get_gap_heatmap(
    ...
    return get_heatmap(artifacts_root, slug)
...
def get_gap_embeddings(
    ...
    return get_embedding_projection(artifacts_root, slug, method=method)
...
def get_spa_trend_endpoint(
    ...
    return get_spa_trend(task_store, slug)
