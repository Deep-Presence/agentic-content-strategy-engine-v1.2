...
class PipelineTask(BaseModel):
    ...
    task_id: str
    pipeline: Literal["research", "gap_analysis", "content", "content_v13", "site_audit", "knowledge_base", "audience_persona", "voice_style_guide", "topic_discovery", "topic_expansion", "research_orchestrator", "td_content", "onboarding", "daily_tracker"]
