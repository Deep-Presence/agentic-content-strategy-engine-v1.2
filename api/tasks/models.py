...
class PipelineTask(BaseModel):
    ...
    task_id: str
    pipeline: Literal["research", "gap_analysis", "content", "content_v13", "site_audit", "knowledge_base", "audience_persona", "voice_style_guide", "topic_discovery", "research_orchestrator"]
