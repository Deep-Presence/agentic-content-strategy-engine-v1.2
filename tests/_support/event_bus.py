"""In-memory EventBus for testing — satisfies EventBusProtocol.

This is a test-only copy of the original EventBus class that was removed
from api/tasks/event_bus.py during Phase 6 (filesystem fallback removal).
Production code uses RedisEventBus exclusively.
"""
...
class InMemoryEventBus:
    ...
    def is_terminal(self, task_id: str) -> bool:
        """Check if the last event for a task is a terminal event."""
